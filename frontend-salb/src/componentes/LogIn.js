        ...
        <div className='contentFormLogIn'>
            <form className='formLogIn'>
                <div class="mb-3 emailAddress">
                  ...
                  <input type="email" class="form-control inputEmail" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder='Email address'/>
                </div>
                <div class="mb-3 passwordEmail">
                  {/*<label for="exampleInputPassword1" class="form-label">Password</label>*/}
                  <input type="password" class="form-control inputPassword" id="exampleInputPassword1" placeholder='Password'/>
                </div>
